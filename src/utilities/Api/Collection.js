...
async function getGameCollection(userId) {
  try {
    ...
    throw new Error("Error fetching collection. Please try again later.");
  }
}
...
async function addGameToCollection(userId, gameId) {
  try {
    ...
    throw new Error ("Error adding game to collection. Please try again later.");
  }
}
...
async function deleteGameFromCollection(userId, gameId) {
  try {
    ...
    throw new Error ("Error deleting game from collection. Please try again later.");
  }
}
