    ...
    <div className="footer-container">
      <footer>
        <div className="footer-links">
          <ul>
            <li>
              <a href="https://www.giantbomb.com/">API</a>
            </li>
            <li>
              <a href="https://gameseeker.netlify.app/">Terms of Use</a>
            </li>
            <li>
              <a href="https://gameseeker.netlify.app/">Privacy Policy</a>
            </li>
            <li>
              <a href="https://gameseeker.netlify.app/">
                Do Not Sell My Personal Information
              </a>
            </li>
            <li>
              <a href="https://gameseeker.netlify.app/">Help</a>
            </li>
            <li>
              <a href="https://gameseeker.netlify.app/">Careers</a>
            </li>
          </ul>
        </div>
        ...
        <div className="copyright">
          <p>© 2024 COPU, INC. ALL RIGHTS RESERVED.</p>
        </div>
      </footer>
    </div>
  );
